...
\begin{tikzpicture}
\scriptsize
\node at (0,0) {\includegraphics[width=0.9\textwidth]{ScaleLab_3_nolabels} };
...
\begin{tikzpicture}
\scriptsize
\node at (0,0) {\includegraphics[width=0.9\textwidth]{ScaleLab_11_nolabels} };
...
\begin{tikzpicture}
\scriptsize
\node at (0,0) { \includegraphics[width=0.95\textwidth]{ScaleLab_18_nolabels} };
